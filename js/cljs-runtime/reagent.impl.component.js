...
if((i < len)){
var k = (ks[i]);
var G__26540 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__26541 = (i + (1));
m = G__26540;
i = G__26541;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__26542 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__26542);
})());
} else {
var v = temp__5459__auto__;
...
return (G__26544__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__26546 = c;
var G__26546__$1 = (((G__26546 == null))?null:G__26546.prototype);
if((G__26546__$1 == null)){
return null;
} else {
return (G__26546__$1["render"]);
}
})() == null))));
});
...
var G__26548 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26548) : reagent.impl.component.as_element.call(null,G__26548));
};
...
var _STAR_current_component_STAR_26554 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_26554;
}});
...
return ((function (G__26555,G__26555__$1){
...
var c = this;
var G__26560_26562 = (c["cljsRatom"]);
if((G__26560_26562 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26560_26562);
}
...
var renders_26564 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_26565 = cljs.core.first(cljs.core.vals(renders_26564));
if((cljs.core.count(renders_26564) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26564))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26565)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26565], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__26563 = name;
switch (G__26563) {
case "":
...
var G__26568 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__26568);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__26569 = fiber;
...
var parent = (function (){var G__26570 = fiber;
if((G__26570 == null)){
return null;
} else {
return (G__26570["return"]);
}
})();
var path = (function (){var G__26571 = parent;
var G__26571__$1 = (((G__26571 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__26571) : reagent.impl.component.fiber_component_path.call(null,G__26571)));
if((G__26571__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26571__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__26573 = c;
if((G__26573 == null)){
return null;
} else {
return (G__26573["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__26574._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__26576 = c;
if((G__26576 == null)){
return null;
} else {
return (G__26576["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__26578 = c;
if((G__26578 == null)){
return null;
} else {
return G__26578._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__26580 = instance;
if((G__26580 == null)){
return null;
} else {
return (G__26580["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__26581 = instance;
if((G__26581 == null)){
return null;
} else {
return G__26581._currentElement;
}
}
})();
var name = (function (){var G__26582 = elem;
var G__26582__$1 = (((G__26582 == null))?null:(G__26582["type"]));
if((G__26582__$1 == null)){
return null;
} else {
return (G__26582__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__26584 = elem;
if((G__26584 == null)){
return null;
} else {
return (G__26584["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__26585._owner;
}
}
})();
var path = (function (){var G__26586 = owner;
var G__26586__$1 = (((G__26586 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__26586) : reagent.impl.component.component_path.call(null,G__26586)));
if((G__26586__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26586__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__26587 = c;
var G__26587__$1 = (((G__26587 == null))?null:G__26587.constructor);
if((G__26587__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__26587__$1);
}
}
})();
