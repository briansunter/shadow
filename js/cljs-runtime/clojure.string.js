...
while(true){
if(!((coll__$1 == null))){
var G__27340 = sb.append([cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(coll__$1))].join(''));
var G__27341 = cljs.core.next(coll__$1);
sb = G__27340;
coll__$1 = G__27341;
continue;
} else {
