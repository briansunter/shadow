...
var G__26588 = o;
(G__26588[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26590__i < G__26590__a.length) {G__26590__a[G__26590__i] = arguments[G__26590__i + 0]; ++G__26590__i;}
  args = new cljs.core.IndexedSeq(G__26590__a,0,null);
} 
...
var G__26592 = o;
(G__26592[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26593__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__26594__i < G__26594__a.length) {G__26594__a[G__26594__i] = arguments[G__26594__i + 0]; ++G__26594__i;}
  args = new cljs.core.IndexedSeq(G__26594__a,0,null);
} 
return G__26593__delegate.call(this,args);};
G__26593.cljs$lang$maxFixedArity = 0;
G__26593.cljs$lang$applyTo = (function (arglist__26595){
var args = cljs.core.seq(arglist__26595);
return G__26593__delegate(args);
});
...
var G__26597 = props;
var G__26597__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26597,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26597);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26597__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26598){
...
var props = map__26599__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26599__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26599,map__26599__$1,props,class$){
return (function (c){
...
});})(map__26599,map__26599__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26601){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26602__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26602,map__26602__$1,on_write){
return (function (){
...
});})(node_value,map__26602,map__26602__$1,on_write))
);
} else {
...
var G__26605 = jsprops;
(G__26605["defaultValue"] = value);

(G__26605["onChange"] = ((function (G__26605,v,value,on_change){
return (function (p1__26604_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26604_SHARP_);
});})(G__26605,v,value,on_change))
);
...
var vec__26608 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26608,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26608,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26608,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___26612 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___26612 == null)){
} else {
var key_26613 = temp__5461__auto___26612;
(jsprops["key"] = key_26613);
}
...
var temp__5461__auto___26614 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___26614 == null)){
} else {
var key_26615 = temp__5461__auto___26614;
reagent.impl.template.oset(jsprops,"key",key_26615);
}
...
var G__26616 = reagent.impl.template.__GT_NativeWrapper();
(G__26616["name"] = c);
...
var G__26617 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26617) : reagent.impl.template.as_element.call(null,G__26617));
} else {
...
var len__4531__auto___26622 = arguments.length;
var i__4532__auto___26623 = (0);
while(true){
if((i__4532__auto___26623 < len__4531__auto___26622)){
args__4534__auto__.push((arguments[i__4532__auto___26623]));

var G__26624 = (i__4532__auto___26623 + (1));
i__4532__auto___26623 = G__26624;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26620){
var G__26621 = cljs.core.first(seq26620);
var seq26620__$1 = cljs.core.next(seq26620);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26621,seq26620__$1);
});
...
break;
default:
var G__26627 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26627;
continue;
...
var n__4408__auto___26629 = a.length;
var i_26630 = (0);
while(true){
if((i_26630 < n__4408__auto___26629)){
(a[i_26630] = reagent.impl.template.as_element((a[i_26630])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___26632 = a.length;
var i_26633 = (0);
while(true){
if((i_26633 < n__4408__auto___26632)){
var val_26634 = (a[i_26633]);
if(((cljs.core.vector_QMARK_(val_26634)) && ((reagent.impl.template.key_from_vec(val_26634) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26633] = reagent.impl.template.as_element(val_26634));

var G__26635 = (i_26633 + (1));
i_26633 = G__26635;
continue;
} else {
}
...
var ctx = ({});
var vec__26636 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26636,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26636,(1),null);
...
var G__26639 = (cljs.core.count(argv) - first_child);
switch (G__26639) {
case (0):
...
case (1):
var G__26640 = comp;
var G__26641 = jsprops;
var G__26642 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__26640,G__26641,G__26642);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__26639){
